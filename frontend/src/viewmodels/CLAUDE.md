...
| `useChat.ts` | The live conversation: message list, streaming, model choice, attachments/upload, quota-aware error text, and scroll pinning. The busiest file in the UI. |
